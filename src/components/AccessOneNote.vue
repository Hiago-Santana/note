        ...
        <div class="p-[2rem]">
            <div class="grid grid-cols-2">
                <button class="place-self-start"
                    @click="toggleModal = false, addChecKBox = false, $emit('visible-notes',true), $emit('show-accessed-note',null)"><font-awesome-icon
...
export default {
    ...
    props: ['idAccessedNote', 'allNote'],
    emits: ['visible-notes', 'show-accessed-note'],
    data(){
        return {
            indexNote: [],
            indexNoteCopy: null,
